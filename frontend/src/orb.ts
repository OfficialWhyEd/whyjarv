...
export function createOrb(canvas: HTMLCanvasElement): Orb {
  ...
  const mat = new THREE.PointsMaterial({
    color: 0xc94b25, size: 0.4, transparent: true, opacity: 0.6,
  ...
  const lineMat = new THREE.LineBasicMaterial({
    color: 0xc94b25, transparent: true, opacity: 0.0,
  ...
  function animate() {
    ...
    if (state === "thinking") { mat.color.lerp(new THREE.Color(0xf0ede8), 0.015); lineMat.color.lerp(new THREE.Color(0xf0ede8), 0.015); }
    else if (state === "speaking") { mat.color.lerp(new THREE.Color(0xe8603a), 0.015); lineMat.color.lerp(new THREE.Color(0xe8603a), 0.015); }
    else if (state === "listening") { mat.color.lerp(new THREE.Color(0xc94b25), 0.02); lineMat.color.lerp(new THREE.Color(0xc94b25), 0.02); }
    else { mat.color.lerp(new THREE.Color(0x8b2e10), 0.015); lineMat.color.lerp(new THREE.Color(0x8b2e10), 0.015); }
